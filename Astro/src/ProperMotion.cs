...
public class ProperMotion {
    ...
    /// </summary>
    public RateOfChange<RightAscension> RightAscensionRate {get; private set;}
    /// <summary>
    /// Rate of change of an object's declination angle
    /// </summary>
    public RateOfChange<Declination> DeclinationRate    {get; private set;}
    /// <summary>
    ...
    public ProperMotion(RateOfChange<RightAscension> raRate, RateOfChange<Declination> decRate) {
