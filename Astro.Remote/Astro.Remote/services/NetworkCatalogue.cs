...
public class CataloguedObject {
    ...
    public double getRa() {
        if (StarData != null) {
            return StarData.Coordinates.RightAscension.TotalDegrees;
        } else if (GalaxyData != null) {
            return GalaxyData.Coordinates.RightAscension.TotalDegrees;
        } else if (OtherDeepSpaceData != null) {
            return OtherDeepSpaceData.Coordinates.RightAscension.TotalDegrees;
        } else {
            return 0;
        }
    }
    ...
    public double getDec() {
        if (StarData != null) {
            return StarData.Coordinates.Declination.TotalDegrees;
        } else if (GalaxyData != null) {
            return GalaxyData.Coordinates.Declination.TotalDegrees;
        }  else if (OtherDeepSpaceData != null) {
            return OtherDeepSpaceData.Coordinates.Declination.TotalDegrees;
        } else {
            return 0;
        }
    }
